...
public class KelimeListesi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kelimelistesi);


        //Spinner tanımlandı ve özellikleri girildi.
        ...
        //Spinner için adapter tanımlandı ve string.xml üzerinden seviye verileri spinnera ekledik.
        ...
        //Seçilen seviyeye göre kelimeleri listelemek için spinnerin item selected listener
        //fonksiyonunu kullandık ve kelimeListele fonksiyonumuzu çağırdık.
        ...
        //Listview üzerinde tıklanan kelimenin bilgilerini kelime detay bölümüne gönderdik.
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long rowId) {
                ...
                Intent intent = new Intent(KelimeListesi.this,KelimeDetay.class);
    ...
    //Uzak veritabanına volley kütüphanesini kullanarak bağlandık.
    //sistem üzerinde bulunan tüm kelimeleri çektik.
    private void kelimeListele(){
        kelimeList.clear();

        url= "http://34.206.170.244/yds/kelimeListele.php?seviye="+seviye;
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    //Tüm kelimeler çekildikten sonra adaptera aktarıldı.
